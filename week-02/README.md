...
- Question (aguenane−stat6250): what is data poration of sas ?
- Answer (aguenane−stat6250): data portion of a sas data set is a collection of data values that are arranged in a rectangular table. 
...
- Question (aguenane−stat6250): What is the difference between data step and proc step ?
- Answer  aguenane-stat6250) data step usually it used for reading and creating a dataset, on the other hand proc step used to produce, formats, analysis and we use it for existing dataset. 
...
- Question (aguenane−stat6250):How many types of variables can we use on Sas ?
- Answer (aguenane−stat6250): on Sas there are just 2 types of variables first tree numeric variables for example (id and age..ect)and the second one is character variable for example (names and country). 
...
- Question (aguenane−stat6250): How can we replace a missing variable in Sas?
...
- Question (aguenane−stat6250): What is the rules for Most Sas Names?
...
- Question (aguenane−stat6250): What is the maximums length for formats and numeric? 
...
- Question (aguenane−stat6250):How sas can read tow-digit or four-digit values?
...
- Question (aguenane−stat6250): Why Range of Libref must be between 1 and 8 characters?
...
- Question (aguenane−stat6250): What does mean the statement YEARCUTOFF = system option?
...
- Question (aguenane−stat6250): Why  we use Libname statement ?
...
- Question (aguenane−stat6250): What we need to do to import data file from excel to sas ? 
...
- Question (aguenane−stat6250): What is the mean reason of using macros on Sas ?
