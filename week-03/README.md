...
- Question (aguenane−stat6250): why usually is good idea to begin data and proc step in column one  ?
...
- Question (aguenane−stat6250): How can we modify program that contain error  for example an spelling error ?
- Answer (aguenane−stat6250): To modify program that contain error, we can editing window and we can correct the errors
...
- Question (aguenane−stat6250): What is the symptom when you have a missing semicolon?
- Answer (aguenane−stat6250): Yo will have a log message indicating an error in a statement that seems to be valid
...
- Question (aguenane−stat6250): Haw can we resolve the error in the Windows operating environment?
- Answer (aguenane−stat6250): we need to Press the Ctrl and Break keys or click the Break Icon on the toolbarand after that click  Cancel Submitted Statements, and then click OK and last click Yes finally  Correct the error and resubmit the program.
...
- Question (aguenane−stat6250): How many syntax type of error we can find in sas ?
...
- Question (aguenane−stat6250): What we need to do When a SAS statement that contains an invalid option is submitted, a message appears in the Log window indicating that the option is not valid or not recognized? 
...
- Question (aguenane−stat6250): Dose logic errors do not stop a program from running ?
...
- Question (aguenane−stat6250): What can I know that a syntax error is detected?
...
- Question (aguenane−stat6250): How can I do to remove the Obs column?
...
- Question (aguenane−stat6250): Dose "WHERE" statement works for both character and numeric variables?
...
- Question (aguenane−stat6250): What is the best way to sort a multiple variables in one statement on sas ? 
...
- Question (aguenane−stat6250): What the mean reason for putting ‘Run” after every Porc Print ?
...
- Question (aguenane−stat6250): What we need to use to find total the values of numeric variables?
...
- Question (aguenane−stat6250): How and for what  we can use ‘NOOB’ ?
...
- Question (aguenane−stat6250): How can we do to remove duplicate records?
...
- Question (aguenane-stat6250): Do we loss original dataset after creating a new data set by using Proc sort?
...
- Question (aguenane−stat6250): What the mean reason of using Title and Footnotes on sas ?
