...
- *Answer* (sbagdi-stat6250): It is considered best practice to explicitly list output column, so that the code is more self-documenting. The drop statement can lso be used to list the columns to keep in output.
