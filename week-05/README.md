...
- *Answer* (asharda-stat6250): Raw data files contain only data, either generated by a programming language or entered with a data entry device or a text editor.
...
- *Answer* (asharda-stat6250): libref. is a shortcut name or a "nickname" for the aggregate storage location where your SAS files are stored. It is any SAS name when you are assigning a new libref. 
...
- *Answer* (asharda-stat6250): It specifies to store the variable value as a character value rather than as a numeric value.
...
- *Answer* (asharda-stat6250): Yes,it is considered as a bad practice.
...
- *Answer* (asharda-stat6250):  Automatic variables are created automatically by the DATA step or by DATA step statements. These variables are added to the program data vector but are not output to the data set being created.
...
- *Answer* (asharda-stat6250):  The STEP command executes the highlighted source line in the debugger and then suspends execution. 
...
- *Answer* (asharda-stat6250): Yes,it does .PROC FCMP routines can be recursive.
...
- *Answer* (asharda-stat6250): A variable that has not been assigned a value is of type undefined.
...
- *Answer* (asharda-stat6250): The _ERROR_ variable can be used in expressions or calculations in the DATA step.
...
- *Answer* (asharda-stat6250): The data step is where data is created, imported, modified, merged, or calculated
...
- *Answer* (asharda-stat6250): retain is used to set variable order, and keep is used to explicitly list the columns to keep in output.
