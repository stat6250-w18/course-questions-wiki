...
- Question (aguenane−stat6250): What is a raw data file? 
...
- Question (aguenane−stat6250): Is it necessary to reference the raw data file when creating a SAS data set?
- Answer (aguenane−stat6250): Yes, we need to reference the raw data file to be read and the name the SAS data set. 
...
- Question (aguenane−stat6250): When do we use a LIBNAME statement?
- Answer (aguenane−stat6250): We use the LIBNAME statement to reference SAS library in which the data set will be stored after we create the SAS data set. 
...
- Question (aguenane−stat6250): What is the use of the INFILE statement in writing a data step program?
...
- Question (aguenane−stat6250): Which statement do we use when submitting the program to explore the new library and contents?
...
- Question (aguenane−stat6250): What is the process of how SAS executing programs in distinct phases?
...
- Question (aguenane−stat6250): What are some of the log outputs we can look at do determine an error in the execution phase?
- Answer (aguenane−stat6250): Depending on the type of error, the log might show a warning and might include invalid data from the input buffer or the program data vector.  
...
- Question (aguenane−stat6250): What are some of the common errors that we encounter in the execution phase?
...
- Question (aguenane−stat6250): Can numeric values in a SAS program include characters?
...
- Question (aguenane−stat6250): How can we use the PUT when testing our programs in SAS?
...
- Question (aguenane−stat6250): How are missing numeric values and missing character values represented in a SAS output?
...
- Question (aguenane−stat6250): When is a RETAIN statement preferred over a KEEP statement in SAS?
...
- Question (aguenane−stat6250): When is using PROC SQL recommended and how do we execute it?
